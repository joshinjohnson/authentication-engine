...
func TestEngine_Authenticate(t *testing.T) {
    ...
    accessWithData.StoreUser(models.UserCredential{
        ...
        Password: access.GetMD5Hash("pass"),
    }, models.UserDetails{
        FirstName: "firstname",
        LastName:  "lastname",
    })
...
func TestEngine_Register(t *testing.T) {
    ...
    for _, tt := range tests {
        t.Run(tt.name, func(t *testing.T) {
            ...
            if got, err := e.access.FetchUserDetails(tt.args.userCredential); err != nil || !reflect.DeepEqual(got, tt.userDetails) {
...
func Test_getMD5Hash(t *testing.T) {
    ...
    for _, tt := range tests {
        t.Run(tt.name, func(t *testing.T) {
            if got := access.GetMD5Hash(tt.args.password); got == tt.args.password {
